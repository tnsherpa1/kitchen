...
class Collapsible extends Component {
  ...
  componentDidUpdate(prevProps: { open: any }, prevState: { height: string }) {
    if (this.state.shouldOpenOnNextCycle as boolean) {
  ...
  render(): any {
    ...
    return (
      <div className={parentClassString.trim()}>
        ...
        >
          <div className={innerClassString.trim()} ref={this.setInnerRef}>
            {children}
          </div>
        </div>
      </div>
